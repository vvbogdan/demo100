...
#import "AGStickerCell.h"
#import "AGDistortionCell.h"
#import "AGFilterCell.h"
#import "AGStickerDownloadManager.h"
#import "AGPresentStickerRenderer.h"
#import "UIDevice+DeviceModel.h"
#import "AGSaveData.h"

static NSString *AGDistortionCellIdentifier = @"AGDistortionCellIdentifier";
static NSString *AGStickerCellIdentifier = @"AGStickerCellIdentifier";
static NSString *AGPresentStickerCollectionViewCellIdentifier = @"AGPresentStickerCollectionViewCellIdentifier";
static NSString *AGFilterCellIdentifier = @"AGFilterCellIdentifier";

@interface AGUIManager () <UICollectionViewDelegate, UICollectionViewDataSource>
...
- (void)createUI {
    ...
    if (self.superView != nil) {
        ...
        tapView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth_AG, ScreenHeight_AG)];
...
//        [self.superView addSubview:self.toggleBtn];
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(stickersLoadedComplete:) name:@"AG_STICKERSLOADED_COMPLETE" object:nil];

        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(colorfiltersLoadedComplete:) name:@"AG_COLORFILTERSLOADED_COMPLETE" object:nil];
...
- (void)pushmainMenuView:(BOOL)isPop {
    ...
    if (isPop) {
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            frame.origin.y = ScreenHeight_AG - 42;
        ...
        [UIView animateWithDuration:0.1 animations:^{
            CGRect frame = self.filterGlobalView.frame;
            frame.origin.y = ScreenHeight_AG;
            self.mainMenuView.frame = frame;
        }];
    }
...
- (UIButton *)toggleBtn {
    if (!_toggleBtn) {
        _toggleBtn = [[UIButton alloc] initWithFrame:CGRectMake(ScreenWidth_AG - 60 - 5, 0, 60, 60)];
...
- (UIButton *)offPhoneBtn {
    if (!_offPhoneBtn) {
        _offPhoneBtn =
                [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 81) / 2, ScreenHeight_AG - 20 - 81, 81, 81)];
...
- (UIScrollView *)mainMenuView {
    if (!_mainMenuView) {
        _mainMenuView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, ScreenHeight_AG, ScreenWidth_AG, 42)];

        [_mainMenuView setBackgroundColor:RGBACOLOR(0, 0, 0, 0.9)];

        _mainMenuView.contentSize = CGSizeMake(ScreenWidth_AG / 5, 42);
...
- (UIView *)filterGlobalView {
    if (!_filterGlobalView) {
        _filterGlobalView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight_AG, ScreenWidth_AG, 101)];
...
- (UIView *)beautifyFilterView {
    if (!_beautifyFilterView) {
        _beautifyFilterView =
                [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight_AG, ScreenWidth_AG, 175 + 52 + 15 - 90)];
        [_beautifyFilterView setBackgroundColor:RGBACOLOR(0, 0, 0, 0.2)];

        UILabel *labTitle = [[UILabel alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 120) / 2, 8, 120, 13)];
        if (IsEnglish) {
        ...
        if (!IsEnglish) {
            ...
            self.sliderEyeMagnifying.frame =
                    CGRectMake(120 - 60, 12 + 52 + 15, ScreenWidth_AG - 67 - 32 - 20 - 30 + 60 - 20, 20);
            self.sliderChinSlimming.frame =
                    CGRectMake(120 - 60, 54 + 52 + 15, ScreenWidth_AG - 67 - 32 - 20 - 30 + 60 - 20, 20);
        }

        UILabel *eyeLabel = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth_AG - 50, 12 + 3 + 52 + 15, 50, 13)];
        ...
        UILabel *faceLabel = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth_AG - 50, 54 + 3 + 52 + 15, 50, 13)];
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            ...
            switch (iDeviceOrientation) {
                ...
                case UIDeviceOrientationPortraitUpsideDown:
                    ...
                    [self resetWithUI:self.distortionOptionsBtn frame:CGRectMake((self.renderManager.varWidth - 46 * 5) / 6 * 2 + 46, 6, 46, 46)];

                    [self resetWithUI:self.beautifyOptionsBtn frame:CGRectMake((self.renderManager.varWidth - 46 * 5) / 6 * 3 + 46 * 2, 6, 46, 46)];
...
- (UIView *)beautifyNewView {
    if (!_beautifyNewView) {
        _beautifyNewView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight_AG, ScreenWidth_AG, 111)];
        [_beautifyNewView setBackgroundColor:RGBACOLOR(0, 0, 0, 0.2)];

        UILabel *labTitle = [[UILabel alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 100) / 2, 5, 100, 13)];
        if (IsEnglish) {
        ...
        btnBeautify1 = [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 46 * 4) / 5, 32, 46, 46)];
        ...
        btnBeautify2 = [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 46 * 4) / 5 * 2 + 46, 32, 46, 46)];
        ...
        btnBeautify3 =
                [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 46 * 4) / 5 * 3 + 46 * 2, 32, 46, 46)];
        ...
        btnBeautify4 =
                [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 46 * 4) / 5 * 4 + 46 * 3, 32, 46, 46)];
...
- (UIView *)slideBeautifyMenuView {
    if (!_slideBeautifyMenuView) {
        _slideBeautifyMenuView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight_AG, ScreenWidth_AG, 240)];
        ...
        if (!IsEnglish) {
            ...
            self.NewBeautifySliderSaturation.frame =
                    CGRectMake(120 - 60, 96 + 52 + 15, ScreenWidth_AG - 67 - 32 - 20 - 30 + 60 - 20, 20);
            self.NewBeautifySliderPinkistender.frame =
                    CGRectMake(120 - 60, 138 + 52 + 15, ScreenWidth_AG - 67 - 32 - 20 - 30 + 60 - 20, 20);
        ...
        UILabel *countLabel1 =
                [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth_AG - 50, 12 + 3 + 52 + 15, 50, 13)];
        ...
        UILabel *countLabel2 =
                [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth_AG - 50, 54 + 3 + 52 + 15, 50, 13)];
        ...
        UILabel *countLabel3 =
                [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth_AG - 50, 96 + 3 + 52 + 15, 50, 13)];
        ...
        UILabel *countLabel4 =
                [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth_AG - 50, 138 + 3 + 52 + 15, 50, 13)];
...
- (UIButton *)enableFilterParmasBtn {
    if (!_enableFilterParmasBtn) {
        _enableFilterParmasBtn = [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 43) / 2, 30, 43, 43)];
...
- (UIButton *)enableBeautifyFilterParmasBtn {
    if (!_enableBeautifyFilterParmasBtn) {
        _enableBeautifyFilterParmasBtn =
                [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 43) / 2, 30, 43, 43)];
...
- (UISlider *)sliderEyeMagnifying {
    if (!_sliderEyeMagnifying) {
        _sliderEyeMagnifying =
                [[UISlider alloc] initWithFrame:CGRectMake(120 - 10, 12 + 52 + 15, ScreenWidth_AG - 67 - 32 - 20 - 30 - 20, 20)];
        ...
        if (![AGSaveData floatForKey:@"AGSliderEyeMagnifying"]) {

            _sliderEyeMagnifying.value = 50;
            [AGSaveData setFloat:50 forKey:@"AGSliderEyeMagnifying"];

        } else {

            _sliderEyeMagnifying.value = [AGSaveData floatForKey:@"AGSliderEyeMagnifying"];
        }

        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_EYEMAGNIFYING value:_sliderEyeMagnifying.value];
...
- (UISlider *)sliderChinSlimming {
    if (!_sliderChinSlimming) {
        _sliderChinSlimming =
                [[UISlider alloc] initWithFrame:CGRectMake(120 - 10, 54 + 52 + 15, ScreenWidth_AG - 67 - 32 - 20 - 30 - 20, 20)];
        ...
        if (![AGSaveData floatForKey:@"AGSliderChinSlimming"]) {

            _sliderChinSlimming.value = 43;
            [AGSaveData setFloat:43 forKey:@"AGSliderChinSlimming"];

        } else {

            _sliderChinSlimming.value = [AGSaveData floatForKey:@"AGSliderChinSlimming"];
        }

        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_CHINSLIMING value:_sliderChinSlimming.value];
...
- (UISlider *)NewBeautifySliderWhitening {
    if (!_NewBeautifySliderWhitening) {
        ...
        if (![AGSaveData floatForKey:@"AGSliderWhitening"]) {

            _NewBeautifySliderWhitening.value = 80;

            [AGSaveData setFloat:80 forKey:@"AGSliderWhitening"];

        } else {

            _NewBeautifySliderWhitening.value = [AGSaveData floatForKey:@"AGSliderWhitening"];
        }

        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_SKINWHITENING value:_NewBeautifySliderWhitening.value];
...
- (UISlider *)NewBeautifySliderMicrodermabrasion {
    if (!_NewBeautifySliderMicrodermabrasion) {
        ...
        if (![AGSaveData floatForKey:@"AGSliderMicrodermabrasion"]) {

            _NewBeautifySliderMicrodermabrasion.value = 81;

            [AGSaveData setFloat:81 forKey:@"AGSliderMicrodermabrasion"];

        } else {

            _NewBeautifySliderMicrodermabrasion.value = [AGSaveData floatForKey:@"AGSliderMicrodermabrasion"];
        }

        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_BLEMISHREMOVAL value:_NewBeautifySliderMicrodermabrasion.value];
...
- (UISlider *)NewBeautifySliderSaturation {
    if (!_NewBeautifySliderSaturation) {
        _NewBeautifySliderSaturation =
                [[UISlider alloc] initWithFrame:CGRectMake(120 - 10, 96 + 52 + 15, ScreenWidth_AG - 67 - 32 - 20 - 30 - 20, 20)];
        ...
        if (![AGSaveData floatForKey:@"AGSliderSaturation"]) {
            ...
            [AGSaveData setFloat:83 forKey:@"AGSliderSaturation"];

        } else {

            _NewBeautifySliderSaturation.value = [AGSaveData floatForKey:@"AGSliderSaturation"];
        }

        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_SKINSATURATION value:_NewBeautifySliderSaturation.value];
...
- (UISlider *)NewBeautifySliderPinkistender {
    if (!_NewBeautifySliderPinkistender) {
        _NewBeautifySliderPinkistender =
                [[UISlider alloc] initWithFrame:CGRectMake(120 - 10, 138 + 52 + 15, ScreenWidth_AG - 67 - 32 - 20 - 30 - 20, 20)];
        ...
        //粉嫩指定初始值
        if (![AGSaveData floatForKey:@"AGSliderPinkistender"]) {

            _NewBeautifySliderPinkistender.value = 56;
            [AGSaveData setFloat:56 forKey:@"AGSliderPinkistender"];

        } else {

            _NewBeautifySliderPinkistender.value = [AGSaveData floatForKey:@"AGSliderPinkistender"];
        }

        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_SKINTENDERNESS value:_NewBeautifySliderPinkistender.value];
...
- (UIView *)stickerMenuView {
    if (!_stickerMenuView) {
        ...
        _stickerMenuView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight_AG, ScreenWidth_AG, 220)];

        [_stickerMenuView setBackgroundColor:RGBACOLOR(0, 0, 0, 0.2)];

        _stickerMenuView.userInteractionEnabled = YES;

        UILabel *stickerLabel = [[UILabel alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 120) / 2., 8, 120, 13)];
...
- (UIView *)distortionMenuView {
    if (!_distortionMenuView) {
        _distortionMenuView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight_AG, ScreenWidth_AG, 185)];
...
- (UIButton *)stickerOptionsBtn {
    if (!_stickerOptionsBtn) {
        ...
        _stickerOptionsBtn.frame = CGRectMake((ScreenWidth_AG - 46 * 5) / 6 + 10, 0, 46, 42);
...
- (UIButton *)distortionOptionsBtn {
    if (!_distortionOptionsBtn) {
        _distortionOptionsBtn =
                [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 46 * 5) / 6 * 2 + 46, 6, 46, 46)];
...
- (UIButton *)beautifyOptionsBtn {
    if (!_beautifyOptionsBtn) {
        _beautifyOptionsBtn =
                [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 46 * 5) / 6 * 3 + 46 * 2, 0, 46, 42)];
...
- (UIButton *)beautifyNewBtn {
    if (!_beautifyNewBtn) {
        ...
        _beautifyNewBtn =
                [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 46 * 5) / 6 * 4 + 46 * 3, 6, 46, 46)];
...
- (UIButton *)pointBtn {
    if (!_pointBtn) {
        _pointBtn = [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 46 * 5) / 6 * 6 + 46 * 5, 6, 46, 46)];
...
- (UIButton *)slideGlobalBeautifyOptionsBtn {
    if (!_slideGlobalBeautifyOptionsBtn) {
        _slideGlobalBeautifyOptionsBtn =
                [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 46 * 5) / 6 * 5 + 46 * 4 - 10, 0, 46, 42)];
...
- (UIButton *)presentSwitchBtn {
    if (!_presentSwitchBtn) {
        _presentSwitchBtn = [[UIButton alloc] initWithFrame:CGRectMake(ScreenWidth_AG - 61, 60, 46, 46)];
...
- (UIButton *)smiliesSwitchBtn {
    if (!_smiliesSwitchBtn) {
        _smiliesSwitchBtn = [[UIButton alloc] initWithFrame:CGRectMake(ScreenWidth_AG - 61, 120, 46, 46)];
...
- (UILabel *)smiliesStateText {
    if (!_smiliesStateText) {
        ...
        _smiliesStateText.frame = CGRectMake((ScreenWidth_AG - 100) / 2, (ScreenHeight_AG - 20) / 2, 100, 20);
...
- (UIButton *)btnIsEnableGrabCut {
    if (!_btnIsEnableGrabCut) {
        _btnIsEnableGrabCut = [[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth_AG - 60) / 2., 0, 60, 60)];
...
- (void)updateValue:(UISlider *)sender {
    if ([sender isEqual:self.sliderEyeMagnifying]) {
        ...
        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_EYEMAGNIFYING value:sender.value];
        [AGSaveData setFloat:sender.value forKey:@"AGSliderEyeMagnifying"];

        if (sender.value == 0) {
            [AGSaveData setFloat:0.01 forKey:@"AGSliderEyeMagnifying"];
        }
    } else if ([sender isEqual:self.sliderChinSlimming]) {
        self.labelChinSlimming.text = [NSString stringWithFormat:@"%d", (int) sender.value];

        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_CHINSLIMING value:sender.value];
        [AGSaveData setFloat:sender.value forKey:@"AGSliderChinSlimming"];
        if (sender.value == 0) {
            [AGSaveData setFloat:0.01 forKey:@"AGSliderChinSlimming"];
...
- (void)newBeautifyUpdateValue:(UISlider *)sender {
    if ([sender isEqual:self.NewBeautifySliderWhitening]) {
        ...
        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_SKINWHITENING value:sender.value];
        [AGSaveData setFloat:sender.value forKey:@"AGSliderWhitening"];
        if (sender.value == 0) {
            [AGSaveData setFloat:0.01 forKey:@"AGSliderWhitening"];
        ...
        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_BLEMISHREMOVAL value:sender.value];
        [AGSaveData setFloat:sender.value forKey:@"AGSliderMicrodermabrasion"];
        if (sender.value == 0) {
            [AGSaveData setFloat:0.01 forKey:@"AGSliderMicrodermabrasion"];
        ...
        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_SKINSATURATION value:sender.value];
        [AGSaveData setFloat:sender.value forKey:@"AGSliderSaturation"];
        if (sender.value == 0) {
            [AGSaveData setFloat:0.01 forKey:@"AGSliderSaturation"];
        ...
        [self.renderManager onNewBeautyParamsChanged:AG_NEWBEAUTY_TYPE_SKINTENDERNESS value:sender.value];
        [AGSaveData setFloat:sender.value forKey:@"AGSliderPinkistender"];
        if (sender.value == 0) {
            [AGSaveData setFloat:0.01 forKey:@"AGSliderPinkistender"];
...
- (void)showMenuSubView:(UIView *)view {
    ...
    if ([view isEqual:self.beautifyFilterView]) {
        frame.origin.y = ScreenHeight_AG - 175 - 42 - 52 - 15 + 90;
    } else if ([view isEqual:self.beautifyNewView]) {
        frame.origin.y = ScreenHeight_AG - 111 - 42;
    } else if ([view isEqual:self.slideBeautifyMenuView]) {
        frame.origin.y = ScreenHeight_AG - 240 - 42;
    } else {
        frame.origin.y = ScreenHeight_AG - 185 - 42;
...
- (void)enableFilterParmasBtnOnClick:(UIButton *)sender {
    [AGSaveData setValue:[NSNumber numberWithBool:sender.isSelected] forKey:@"AGEnableBigEyeSlimChin"];
    [sender setSelected:!sender.isSelected];
...
- (void)enableBeautifyFilterParmasBtnOnClick:(UIButton *)sender {
    [AGSaveData setValue:[NSNumber numberWithBool:sender.isSelected] forKey:@"AGEnableBeautyFilter"];
    [sender setSelected:!sender.isSelected];
...
- (void)pushFilterGlobalView:(BOOL)isPop {
    ...
    if (isPop) {
        ...
        [UIView animateWithDuration:0.3 animations:^{
            CGRect frame = self.filterGlobalView.frame;
            frame.origin.y = ScreenHeight_AG - 101;
...
- (void)initDefaultParams {
    //大眼瘦脸开关
    if ([AGSaveData valueForKey:@"AGEnableBigEyeSlimChin"] == nil) {

        [self enableBigEyeSlimChin:YES];
        [AGSaveData setValue:[NSNumber numberWithBool:YES] forKey:@"AGEnableBigEyeSlimChin"];

    } else {

        [self enableBigEyeSlimChin:[[AGSaveData valueForKey:@"AGEnableBigEyeSlimChin"] boolValue]];

    };


    //全局美颜开关
    if ([AGSaveData valueForKey:@"AGEnableBeautyFilter"] == nil) {

        [self enableBeautyFilter:YES];
        [AGSaveData setValue:[NSNumber numberWithBool:YES] forKey:@"AGEnableBeautyFilter"];

    } else {

        [self enableBeautyFilter:[[AGSaveData valueForKey:@"AGEnableBeautyFilter"] boolValue]];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    if (buttonIndex == 1) {
        ...
        [[AGStickerDownloadManager sharedInstance] downloadStickers:self.renderManager.stickers withAnimation:^(NSInteger index) {

            NSIndexPath *indexPath = [NSIndexPath indexPathForItem:index + 2 inSection:0];
            AGStickerCell *cell = (AGStickerCell *) [self.stickersCollectionView cellForItemAtIndexPath:indexPath];
            [cell startDownload];
            ...
            sticker.downloadState = AGStickerDownloadStateDownoadDone;
            ...
            sticker.downloadState = AGStickerDownloadStateDownoadNot;
            dispatch_async(dispatch_get_main_queue(), ^{
                [self.stickersCollectionView reloadData];
                // TODO: 提示用户网络不给力
            });
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //    AGStickerCell *cell;
    //    AGFilterCell *textCell;

    if (collectionView == self.stickersCollectionView) {

        cell = [collectionView dequeueReusableCellWithReuseIdentifier:AGStickerCellIdentifier forIndexPath:indexPath];

        [cell sizeToFit];

        if (indexPath.item <= 2) {

            [((AGStickerCell *) cell) setSticker:nil index:indexPath.item];

        } else {

            AGSticker *sticker = self.renderManager.stickers[indexPath.item - 2 - 1];

            [((AGStickerCell *) cell) setSticker:sticker index:indexPath.item];

        }

        if (self.renderManager.currentStickerIndex == indexPath.item - 2 - 1) {

            [((AGStickerCell *) cell) hideBackView:NO];

        } else {

            [((AGStickerCell *) cell) hideBackView:YES];

        }
    } else if (collectionView == self.distortionCollectionView) {
        cell =
                [collectionView dequeueReusableCellWithReuseIdentifier:AGDistortionCellIdentifier forIndexPath:indexPath];

        [cell sizeToFit];

        ((AGDistortionCell *) cell).imgView.image =
                [UIImage imageNamed:self.renderManager.distortionTitleInfosArr[indexPath.item]];
        if (indexPath.row == 0) {
            [cell setSelected:YES];
        }
    } else if (collectionView == self.globalBeatifyFilterCollectionView) {
        cell = [collectionView dequeueReusableCellWithReuseIdentifier:AGFilterCellIdentifier forIndexPath:indexPath];

        [cell sizeToFit];

        if (self.renderManager.currentFilterIndex == indexPath.item - 1) {

            [((AGFilterCell *) cell) hideBackView:NO];

        } else {
            [((AGFilterCell *) cell) hideBackView:YES];

        }

        if (indexPath.item == 0) {
            [((AGFilterCell *) cell) setName:nil andIcon:nil index:indexPath.item];

        } else {

            AGGlobalFilter *filer = self.renderManager.globalFilters[indexPath.item - 1];

            [((AGFilterCell *) cell) setName:filer.name andIcon:[UIImage imageWithContentsOfFile:[filer.filterResourceDir stringByAppendingPathComponent:@"thumb.png"]] index:indexPath.item];
        }
    }
    ...
    if (collectionView == self.stickersCollectionView) {
        ...
        if (indexPath.item > 2) {
            ...
            if (sticker.isDownload == NO) {
                ...
                [[AGStickerDownloadManager sharedInstance] downloadSticker:sticker index:indexPath.item - 2 - 1 withAnimation:^(NSInteger index) {

                    NSIndexPath *indexPath = [NSIndexPath indexPathForItem:index + 2 + 1 inSection:0];
                    AGStickerCell
                            *cell = (AGStickerCell *) [self.stickersCollectionView cellForItemAtIndexPath:indexPath];
                    [cell startDownload];
        ...
        AGStickerCell *lastCell = (AGStickerCell *) [collectionView cellForItemAtIndexPath:lastPath];
        ...
        //显示选中cell的背景
        AGStickerCell *cell = (AGStickerCell *) [collectionView cellForItemAtIndexPath:indexPath];
        ...
        AGFilterCell *lastCell = (AGFilterCell *) [collectionView cellForItemAtIndexPath:lastPath];
        [lastCell hideBackView:YES];
        ...
        //显示选中cell的背景
        AGFilterCell *cell = (AGFilterCell *) [collectionView cellForItemAtIndexPath:indexPath];
...
- (UICollectionView *)stickersCollectionView {
    if (!_stickersCollectionView) {
        ...
        flowLayout.itemSize = CGSizeMake((ScreenWidth_AG) / 7, (ScreenWidth_AG) / 7);
        ...
        _stickersCollectionView =
                [[UICollectionView alloc] initWithFrame:CGRectMake(0, 30, ScreenWidth_AG, 200) collectionViewLayout:flowLayout];

        //注册cell
        [_stickersCollectionView registerClass:[AGStickerCell class] forCellWithReuseIdentifier:AGStickerCellIdentifier];
...
- (UICollectionView *)distortionCollectionView {
    if (!_distortionCollectionView) {
        ...
        _distortionCollectionView =
                [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth_AG, 185) collectionViewLayout:flowLayout];

        //注册cell
        [_distortionCollectionView registerClass:[AGDistortionCell class] forCellWithReuseIdentifier:AGDistortionCellIdentifier];
...
- (UICollectionView *)globalBeatifyFilterCollectionView {
    if (!_globalBeatifyFilterCollectionView) {
        ...
        _globalBeatifyFilterCollectionView =
                [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth_AG, 101) collectionViewLayout:flowLayout];

        //注册cell
        [_globalBeatifyFilterCollectionView registerClass:[AGFilterCell class] forCellWithReuseIdentifier:AGFilterCellIdentifier];
